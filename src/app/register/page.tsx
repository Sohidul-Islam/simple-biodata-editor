      ...
      <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 space-y-8 shadow-2xl relative z-10 transition duration-300 hover:border-slate-700/80">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">
            Sign up to build and customize premium biodatas
          </p>
        </div>

        <form action={formAction} className="space-y-5">
          {state?.error && (
            <div className="bg-rose-950/50 border border-rose-800/80 text-rose-300 p-4 rounded-2xl text-xs flex items-center gap-2.5 animate-pulse">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-300 tracking-wide uppercase px-1">Password</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-500">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
